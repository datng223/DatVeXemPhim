namespace DatVeXemPhim.Payloads.Responses
{
    public class ResponseObject<T>
    {
        ...
        public ResponseObject<T> ResponseError(int status, string message)
        {
            return new ResponseObject<T>(status, message, default(T));
        }
    }
}
