...
namespace DatVeXemPhim.DataContext
{
    public class AppDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer($"Server = DESKTOP-NRR7GCT\\SQLEXPRESS; Database = DatVeXemPhim; Trusted_Connection=True; TrustServerCertificate = True");
        }
    }
}
